...
<head>
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    .logo { width: 42px; height: 42px; border-radius: 10px; background: rgba(255,255,255,.16); display: grid; place-items: center; font-weight: 800; }
...
<body>
  ...
  <div class="sheet">
      ...
      <div class="foot">
        <div class="note">
          @if(!empty($payment->paystack_reference))
            Paystack Reference: {{ $payment->paystack_reference }}
          @else
    ...
    <div class="tiny">Generated by NewPOS</div>
  </div>

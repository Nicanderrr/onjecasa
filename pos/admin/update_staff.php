...
if (isset($_POST['UpdateStaff'])) {
  ...
  if (empty($_POST["staff_number"]) || empty($_POST["staff_name"]) || empty($_POST['staff_email']) || empty($_POST['staff_pincode'])) {
    ...
    $update = $_GET['update'];
    $newq = "SELECT staff_pincode FROM rpos_staff where staff_pincode ='$staff_pincode'";
    $res = mysqli_query($mysqli, $newq);
    if(mysqli_num_rows($res) >0 ){
      $err = "Please Try Again Or Pinocde Already Exists!";
    }
    else{
    ...
    //bind paramaters
    $rc = $postStmt->bind_param('ssssi', $staff_number, $staff_name, $staff_email, $staff_pincode, $update);
    $postStmt->execute();
                ...
                <form method="POST">
                  ...
                  <div class="form-row">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="password" name="staff_pincode" class="form-control" maxlength="4" value="">
                    </div>
                  </div>
                  <br>
                  <div class="form-row">

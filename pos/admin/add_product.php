...
if (isset($_POST['addProduct'])) {
  ...
  if (empty($_POST["prod_code"]) || empty($_POST["prod_name"]) || empty($_POST['prod_desc']) || empty($_POST['prod_price'])) {
    ...
    //bind paramaters
    $rc = $postStmt->bind_param('ssssssssss', $prod_id, $prod_code, $prod_name, $prod_img, $prod_desc, $prod_price, $prod_cost, $prod_catg, $prod_stock,$prod_barcode);
    $postStmt->execute();
          ...
          <div class="card shadow">
              ...
              <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" name="prod_cost" class="form-control" value="">
                  </div>
                </div>
                <hr>
                <div class="form-row">
                  <div class="col-md-6">
                    ...
                    <input 
                     type="file" name="prod_img" class="btn btn-outline-success form-control" value="">
                  </div>
                  <div class="col-md-6">
            ...
            <?php }?>
                ...
                <div class="form-row">
                  <div class="col-md-6">
                    <label>Barcode</label>
                    <input type="text" name="prod_barcode" class="form-control" value="">
                  </div>
                  <div class="col-md-6">
                    <label>Stock</label>
                    <input type="text" name="prod_stock" class="form-control" value="">
                  </div>
                </div>
                <hr>

...
@section('page-actions')
  <a href="{{ route('admin.orders.index') }}" class="btn btn-outline-secondary btn-sm"><i class="bi bi-receipt"></i> Orders</a>
          ...
          <tr data-filter-row>
            ...
            <td>
              <div class="payment-order">
                <a href="{{ route('admin.orders.show', $payment->order_id) }}">{{ $payment->order_code }}</a>

...
<body>
    ...
    $qq = "SELECT *,GROUP_CONCAT(PNAME SEPARATOR ', ') AS PNAMES, SUM(TOTAL) AS TOT, SUM(QTY) AS QTYS FROM invoice_products WHERE order_status = 'Paid' GROUP BY SID ORDER BY created_at DESC";
                                    ...
                                    ?>
                                        <tr  class="text-center">
                                            ...
                                            <td>
                                                <a target="_blank" href="print.php?id=<?php echo $order->SID; ?>">

        ...
        <div class="row">
          <div class="col">
              ...
              <div class="card-body">
                <form method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-row">
                    ...
                    <input type="text" name="prod_cost" class="form-control" value="<?php echo $prod->prod_cost; ?>">
                  </div>
                  </div>
                  <hr>
                  <div class="form-row">
            ...
            <?php }?>
                  ...
                  <div class="col-md-6">
                    <label>Barcode</label>
                    <input type="text" name="prod_barcode" class="form-control" value="<?php echo $prod->prod_barcode; ?>">
                  </div>
                  <div class="col-md-6">
                    <label>Stock</label>
                    <input type="text" name="prod_stock" class="form-control" value="<?php echo $prod->prod_stock; ?>">
                  </div>
                </div>
                <hr>
                  <div class="form-row">

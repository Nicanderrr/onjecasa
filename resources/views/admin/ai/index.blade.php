...
@section('title', 'AI Assistant - NewPOS')
  ...
  <article class="ai-console">
    <header class="ai-console-header">
      <div class="ai-console-identity">
        ...
        <div>
          <span class="ai-kicker">NewPOS Intelligence</span>
...
(() => {
  ...
  const addMessage = (role, text) => {
    ...
    meta.textContent = `${role === 'user' ? 'You' : 'NewPOS AI'} | ${new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}`;

...
@section('page-actions')
  ...
  <a href="{{ route('admin.orders.index') }}" class="btn btn-primary btn-sm"><i class="bi bi-receipt-cutoff"></i> Orders</a>
@endsection
          ...
          <tr data-filter-row>
            ...
            <td>
              <div class="sale-order">
                <a href="{{ route('admin.orders.show', $sale->id) }}">{{ $sale->code }}</a>

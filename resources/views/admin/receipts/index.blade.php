...
@section('page-actions')
  <a href="{{ route('admin.payments.index') }}" class="btn btn-outline-secondary btn-sm"><i class="bi bi-wallet2"></i> Payments</a>
  <a href="{{ route('admin.orders.create') }}" class="btn btn-primary btn-sm"><i class="bi bi-plus-circle"></i> New Order</a>
@endsection
          ...
          <tr data-filter-row>
            ...
            <td>
              <div class="receipt-order">
                <a href="{{ route('admin.receipts.show', $receipt->id) }}">{{ $receipt->code }}</a>
            ...
            <td>
              <div class="receipt-actions">
                <a class="btn btn-sm btn-outline-primary" href="{{ route('admin.receipts.show', $receipt->id) }}"><i class="bi bi-eye"></i> Open</a>
                <a class="btn btn-sm btn-outline-success" href="{{ route('admin.receipts.print', $receipt->id) }}" target="_blank"><i class="bi bi-printer"></i></a>
              </div>
            </td>
          </tr>
        @empty

        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              ...
              <h2 style="color:rgb(114,250,250)">Login As Administrator / Cashier</h2>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary shadow border-0">
            <div class="card-body px-lg-5 py-lg-5">
              <form method="POST" action="{{ route('login.submit') }}" role="form">
                @csrf
                ...
                <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" required name="email" placeholder="Email" type="email" value="{{ old('email') }}">
                  </div>
                </div>
                ...
                <div class="custom-control custom-control-alternative custom-checkbox">
                  <input class="custom-control-input" id="customCheckLogin" type="checkbox" disabled>
          ...
          <div class="row mt-3"><div class="col-6"></div></div>
        </div>
      </div>
    </div>
  </div>

    ...
    <section class="glass shadow">
      <div class="auth-layout">
        <aside class="auth-splash">
          ...
          <div class="small text-white-50">Powered by the adminHMD interface system.</div>
        </aside>
          ...
          <form id="loginForm" class="auth-form-wrap" method="POST" action="{{ route('admin.login.submit') }}">
            ...
            <div class="mb-3">
              ...
              <div class="input-group input-group-alternative">
                ...
                <input id="email" class="form-control" type="email" name="email" value="{{ old('email') }}" placeholder="admin@mail.com" required autocomplete="username">
              </div>
            </div>
